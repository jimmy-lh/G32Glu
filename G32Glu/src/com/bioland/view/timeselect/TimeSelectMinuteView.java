...
public class TimeSelectMinuteView extends View implements OnTouchListener, SelectListener {
	...
	private static final String TAG = "TimeSelectMinuteView";
	...
	public TimeSelectMinuteView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		this.context = context;
		initPaint();
	}

	public TimeSelectMinuteView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initPaint();
	}

	public TimeSelectMinuteView(Context context) {
		super(context);
		this.context = context;
		initPaint();
	}
