...
public class TimeSelectHourView extends View implements OnTouchListener, SelectListener {
	...
	private static final String TAG = "TimeSelectHourView";
	...
	public TimeSelectHourView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		this.context = context;
		initPaint();
	}

	public TimeSelectHourView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initPaint();
	}

	public TimeSelectHourView(Context context) {
		super(context);
		this.context = context;
		initPaint();
	}
